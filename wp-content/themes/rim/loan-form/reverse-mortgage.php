<form class="submit-form" action="" data-url="<?php echo get_template_directory_uri(); ?>/mail/reverse-mail.php" method="post">
            <div id="sf1" class="frm">
             <div class="row">
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            <label for="exampleInputEmail1">Kind of property you can mortgage?</label>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            ...
            <select class="form-control" name="currently_employed">
              <option value="Retired (Govt Employee)">Retired (Govt Employee)</option>
              <option value="Retired ( Pvt Employee)">Retired ( Pvt Employee)</option>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="property_city" placeholder="" required>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            <label for="exampleInputEmail1">Do you have any other running loan?</label>
            <select class="form-control" name="running_loan">
				  <option value="Yes">Yes</option>
				  <option value="No">No</option>
				</select>
          </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="form-group">
            ...
            <div class="input-group mb-2">
              <input type="text" class="form-control" name="currently_residing" placeholder="">
            </div>
          </div>
         </div>
      </div>
    ...
    <form class="submit-form" action="" data-url="<?php echo get_template_directory_uri(); ?>/mail/reverse-mail-second.php" method="post">
           <div class="row">
           		<div class="col-sm-12 col-md-4">
          <div class="form-group">
