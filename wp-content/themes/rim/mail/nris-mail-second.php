...
$salry_account_bank=isset($_POST['salry_account_bank'])?$_POST['salry_account_bank']:'';
...
if(!empty($emailErr)){
	...
	$subject = 'Loan For NRIs Enquiry Part-2';
	$message = "<table width='100%' border='0' cellspacing='3' cellpadding='3' style='border: #009999 2px solid'>
	  ...
	  <tr>
		...
		<td><strong>Your salary a/c is with( Bank Name)?</strong></td>
		<td>$salry_account_bank</td>
	  </tr>
</table>";
